...
class _AuthCardState extends State<AuthCard>  with SingleTickerProviderStateMixin{
  ...
  void initState() { 
    ...
    _opacity = Tween(begin: 0.0, end:  1.0).animate(CurvedAnimation(curve: Curves.easeIn, parent: _controller));
  ...
  void _submit() {
    ...
    try{
      ...
      Provider.of<Auth>(context).login(_authData['email'], _authData['password']);
       print("Loged in");
    } else {
      // Sign user up
      ...
      if(error.toString().contains('EMAIL_EXISTS')){
        errorMessage = 'This email is already used by somebody';
      }
      if(error.toString().contains('INVALID_EMAIL')){
        errorMessage = 'This email is not a valide one';
      }
